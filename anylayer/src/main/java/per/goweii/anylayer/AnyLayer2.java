/**
 * 这个是向R.id.content布局添加子View
 * 后面修改为向DecorView添加子View
 * 因为DecorView会包含虚拟导航栏和状态栏和ActionBar，所以需要计算去除导航栏区域
 * 暂时保留原类的实现
 */
...
// * @author Cuizhen
// */
//public class AnyLayer2 implements LayerManager.LifeListener {
//
...
//
//    public static AnyLayer2 with(@NonNull Context context) {
//        return new AnyLayer2(context);
//    }
//
//    public static AnyLayer2 with(@NonNull ViewGroup viewGroup) {
//        return new AnyLayer2(viewGroup);
//    }
//
//    public static AnyLayer2 target(@NonNull View targetView) {
//        return new AnyLayer2(targetView);
//    }
//
//    private AnyLayer2(@NonNull Context context) {
//        mContext = context;
...
//    }
//
//    private AnyLayer2(@NonNull ViewGroup viewGroup) {
...
//    }
//
//    private AnyLayer2(@NonNull View targetView) {
...
//    }
//
//    public AnyLayer2 contentView(@NonNull View contentView) {
//        mContent = contentView;
//        return this;
//    }
//
//    public AnyLayer2 contentView(@LayoutRes int contentViewId) {
//        mContent = mInflater.inflate(contentViewId, mViewHolder.getContainer(), false);
//        return this;
//    }
//
//    public AnyLayer2 bindData(IDataBinder dataBinder) {
//        mDataBinder = dataBinder;
//        return this;
//    }
//
//    public AnyLayer2 onVisibleChangeListener(OnVisibleChangeListener mOnVisibleChangeListener) {
//        this.mOnVisibleChangeListener = mOnVisibleChangeListener;
//        return this;
//    }
//
//    public AnyLayer2 onLayerShowListener(OnLayerShowListener onLayerShowListener) {
//        mOnLayerShowListener = onLayerShowListener;
//        return this;
//    }
//
//    public AnyLayer2 onLayerDismissListener(OnLayerDismissListener onLayerDismissListener) {
//        mOnLayerDismissListener = onLayerDismissListener;
//        return this;
//    }
//
//    public AnyLayer2 gravity(int gravity) {
//        mGravity = gravity;
//        return this;
//    }
//
//    public AnyLayer2 alignment(@NonNull Alignment.Direction direction,
...
//    }
//
//    public AnyLayer2 contentAnim(IAnim contentAnim) {
//        this.mContentAnim = contentAnim;
//        return this;
//    }
//
//    public AnyLayer2 contentInAnim(@AnimRes int anim) {
//        contentInAnim(AnimationUtils.loadAnimation(mContext, anim));
//        return this;
//    }
//
//    public AnyLayer2 contentInAnim(@NonNull Animation anim) {
//        mContentInAnim = anim;
//        mContentInAnimDuration = mContentInAnim.getDuration();
//        return this;
//    }
//
//    public AnyLayer2 contentOutAnim(@AnimRes int anim) {
//        contentOutAnim(AnimationUtils.loadAnimation(mContext, anim));
//        return this;
//    }
//
//    public AnyLayer2 contentOutAnim(@NonNull Animation anim) {
//        mContentOutAnim = anim;
//        mContentOutAnimDuration = mContentOutAnim.getDuration();
//        return this;
//    }
//
//    public AnyLayer2 backgroundAnim(IAnim backgroundAnim) {
//        this.mBackgroundAnim = backgroundAnim;
//        return this;
//    }
//
//    public AnyLayer2 backgroundInAnim(@AnimRes int anim) {
//        backgroundInAnim(AnimationUtils.loadAnimation(mContext, anim));
//        return this;
//    }
//
//    public AnyLayer2 backgroundInAnim(@NonNull Animation anim) {
//        mBackgroundInAnim = anim;
//        mBackgroundInAnimDuration = mBackgroundInAnim.getDuration();
//        return this;
//    }
//
//    public AnyLayer2 backgroundOutAnim(@AnimRes int anim) {
//        backgroundOutAnim(AnimationUtils.loadAnimation(mContext, anim));
//        return this;
//    }
//
//    public AnyLayer2 backgroundOutAnim(@NonNull Animation anim) {
//        mBackgroundOutAnim = anim;
//        mBackgroundOutAnimDuration = mBackgroundOutAnim.getDuration();
//        return this;
//    }
//
//    public AnyLayer2 defaultContentAnimDuration(long defaultAnimDuration) {
//        this.mContentInAnimDuration = defaultAnimDuration;
//        this.mContentOutAnimDuration = defaultAnimDuration;
//        return this;
//    }
//
//    public AnyLayer2 defaultContentInAnimDuration(long defaultInAnimDuration) {
//        this.mContentInAnimDuration = defaultInAnimDuration;
//        return this;
//    }
//
//    public AnyLayer2 defaultContentOutAnimDuration(long defaultOutAnimDuration) {
//        this.mContentOutAnimDuration = defaultOutAnimDuration;
//        return this;
//    }
//
//    public AnyLayer2 defaultBackgroundAnimDuration(long defaultAnimDuration) {
//        this.mBackgroundInAnimDuration = defaultAnimDuration;
//        this.mBackgroundOutAnimDuration = defaultAnimDuration;
//        return this;
//    }
//
//    public AnyLayer2 defaultBackgroundInAnimDuration(long defaultInAnimDuration) {
//        this.mBackgroundInAnimDuration = defaultInAnimDuration;
//        return this;
//    }
//
//    public AnyLayer2 defaultBackgroundOutAnimDuration(long defaultOutAnimDuration) {
...
//     * @return PopupView
//     */
//    public AnyLayer2 backgroundBlurRadius(@FloatRange(from = 0, fromInclusive = false, to = 25) float radius) {
//        mBackgroundBlurRadius = radius;
//        return this;
//    }
//
//    public AnyLayer2 backgroundBlurScale(@FloatRange(from = 1) float scale) {
//        mBackgroundBlurScale = scale;
//        return this;
//    }
//
//    public AnyLayer2 backgroundBitmap(@NonNull Bitmap bitmap) {
//        mBackgroundBitmap = bitmap;
//        return this;
//    }
//
//    public AnyLayer2 backgroundResource(@DrawableRes int resource) {
//        mBackgroundResource = resource;
//        return this;
//    }
//
//    public AnyLayer2 backgroundDrawable(@NonNull Drawable drawable) {
...
//     * @return PopupView
//     */
//    public AnyLayer2 backgroundColorInt(@ColorInt int colorInt) {
//        mBackgroundColor = colorInt;
//        return this;
//    }
//
//    public AnyLayer2 backgroundColorRes(@ColorRes int colorRes) {
//        mBackgroundColor = ContextCompat.getColor(mContext, colorRes);
//        return this;
//    }
//
//    public AnyLayer2 cancelableOnTouchOutside(boolean cancelable) {
//        mCancelableOnTouchOutside = cancelable;
//        return this;
//    }
//
//    public AnyLayer2 cancelableOnClickKeyBack(boolean cancelable) {
//        mLayerManager.setCancelableOnClickKeyBack(cancelable);
//        return this;
//    }
//
//    public AnyLayer2 onClick(@IdRes int viewId, OnLayerClickListener listener) {
//        mViewHolder.addOnClickListener(listener, viewId, null);
//        return this;
//    }
//
//    public AnyLayer2 onClick(OnLayerClickListener listener, @IdRes int viewId, @IdRes int... viewIds) {
//        mViewHolder.addOnClickListener(listener, viewId, viewIds);
//        return this;
//    }
//
//    public AnyLayer2 onClickToDismiss(@IdRes int viewId, @IdRes int... viewIds) {
//        mViewHolder.addOnClickListener(new OnLayerClickListener() {
//            @Override
//            public void onClick(AnyLayer2 anyLayer, View v) {
//                dismiss();
//            }
//        }, viewId, viewIds);
//        return this;
...
//     * 在{@link OnVisibleChangeListener#onShow(AnyLayer2)}中调用
...
//    /**
//     * 移除软键盘适配
//     * 在{@link OnVisibleChangeListener#onDismiss(AnyLayer2)}中调用
...
//            mOnVisibleChangeListener.onShow(AnyLayer2.this);
//        }
//        if (mDataBinder != null) {
//            mDataBinder.bind(this);
//        }
//        if (mOnLayerShowListener != null) {
//            mOnLayerShowListener.onShowing(AnyLayer2.this);
//        }
//    }
//
//    @Override
...
//    public void onShow() {
//        if (mOnLayerShowListener != null) {
//            mOnLayerShowListener.onShown(AnyLayer2.this);
//        }
//    }
//
//    @Override
...
//            mOnLayerDismissListener.onDismissing(AnyLayer2.this);
//        }
//    }
//
//    @Override
...
//        if (mOnVisibleChangeListener != null) {
//            mOnVisibleChangeListener.onDismiss(AnyLayer2.this);
//        }
//        if (mOnLayerDismissListener != null) {
//            mOnLayerDismissListener.onDismissed(AnyLayer2.this);
//        }
//        mViewHolder.recycle();
//    }
//
...
//         */
//        void bind(AnyLayer2 anyLayer);
//    }
//
//    public interface OnLayerClickListener {
//        void onClick(AnyLayer2 anyLayer, View v);
//    }
//
//    public interface OnLayerDismissListener {
//        void onDismissing(AnyLayer2 anyLayer);
//
//        void onDismissed(AnyLayer2 anyLayer);
//    }
//
//    public interface OnLayerShowListener {
//        void onShowing(AnyLayer2 anyLayer);
//
//        void onShown(AnyLayer2 anyLayer);
//    }
//
//    public interface OnVisibleChangeListener {
//        void onShow(AnyLayer2 anyLayer);
//
//        void onDismiss(AnyLayer2 anyLayer);
//    }
//}
